function Y = LSF (X)
    ...
    format long;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %                      Semiprobabilistic Load Configuration
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    iter=iter+1
    X(18)=0.99*114E3;
    X(19)=0.99*33.70E3;
    ...
    system('"C:\Users\User\AppData\Local\Programs\Python\Python312\python.exe" "C:\AnsysWD\VariableToAPDL_R01.py"');
    % Execute Ansys
